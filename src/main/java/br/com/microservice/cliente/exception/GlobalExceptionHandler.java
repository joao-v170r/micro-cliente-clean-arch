...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ClienteError.ClienteNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseEntity<Object> handleClienteNotFound(ClienteError.ClienteNotFoundException ex, WebRequest request) {
    ...
    // 404 - Cliente não encontrado
    @ExceptionHandler(ClienteMongoError.ClienteNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseEntity<Object> handleClienteNotFound(ClienteMongoError.ClienteNotFoundException ex, WebRequest request) {
        return ResponseEntity
                .status(HttpStatus.NOT_FOUND)
                .body(createErrorResponse(HttpStatus.NOT_FOUND, ex.getMessage(), request));
    }
    ...
    @ExceptionHandler(ClienteError.ClienteAlreadyExistsException.class)
    @ResponseStatus(HttpStatus.CONFLICT)
    public ResponseEntity<Object> handleClienteAlreadyExists(ClienteError.ClienteAlreadyExistsException ex, WebRequest request) {
        return ResponseEntity
    ...
    @ExceptionHandler(ClienteMongoError.ClientePersistenceException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ResponseEntity<Object> handlePersistenceException(ClienteMongoError.ClientePersistenceException ex, WebRequest request) {
        return ResponseEntity
                .internalServerError()
